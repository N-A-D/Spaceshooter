...
PLAYER_SHIP_TYPES, ENEMY_SHIP_TYPES, METEOR_TYPES, AMMO_TYPES, POWER_UP_TYPES, SHIELD, LASER_ANIMATIONS = manipulate_sprite_sheet()

for enemy in PLAYER_SHIP_TYPES:
    print(enemy["name"])